...
/// @nodoc
class _$RegisterMediaTearOff {
  const _$RegisterMediaTearOff();
...
/// @nodoc
const $RegisterMedia = _$RegisterMediaTearOff();

/// @nodoc
mixin _$RegisterMedia {
  ...
  @JsonKey(ignore: true)
  $RegisterMediaCopyWith<RegisterMedia> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RegisterMediaCopyWith<$Res> {
  factory $RegisterMediaCopyWith(
          RegisterMedia value, $Res Function(RegisterMedia) then) =
      _$RegisterMediaCopyWithImpl<$Res>;
  $Res call({User user});
}

/// @nodoc
class _$RegisterMediaCopyWithImpl<$Res>
    implements $RegisterMediaCopyWith<$Res> {
  _$RegisterMediaCopyWithImpl(this._value, this._then);

  final RegisterMedia _value;
  // ignore: unused_field
  final $Res Function(RegisterMedia) _then;
...
class __$ByCloudDataSourceCopyWithImpl<$Res>
    extends _$RegisterMediaCopyWithImpl<$Res>
...
class _$_ByCloudDataSource implements _ByCloudDataSource {
  ...
  @override
  String toString() {
    return 'RegisterMedia.byCloudDataSource(user: $user)';
  }
...
abstract class _ByCloudDataSource implements RegisterMedia {
...
class _$_ByFirebaseDataSource implements _ByFirebaseDataSource {
  ...
  @override
  String toString() {
    return 'RegisterMedia.byFirebaseDataSource(user: $user)';
  }
...
abstract class _ByFirebaseDataSource implements RegisterMedia {
